    ...
    public class PartialMeasurementsController : BaseModelController<PartialMeasurement>
    {
        ...
        public PartialMeasurementsController(SmartWeightDbContext context) : base(context) 
        {
            ...
            timer.Elapsed += (state, args) =>
            {
                ...
                if (_context.Measurements.ToList().Count == 0) return;
        ...
        protected override void AddEntity(PartialMeasurement entity) => _context.Measurements.Add(entity as Measurement);
        protected override List<PartialMeasurement> GetEntities() => _context.Measurements
            .Where(m => m is PartialMeasurement)
            .ToList<PartialMeasurement>();
        protected override PartialMeasurement? GetEntity(int id) => _context.Measurements.First(m => m.Id == id);
        protected override void DeleteEntity(PartialMeasurement entity) => _context.Measurements.Remove(entity as Measurement);
